...
const gameQuizQuestions = [
    ...
    { q: "A client scheduled for MRI reports having a pacemaker. What is the priority action?", category: "diagnostics", options: ["Explain procedure", "Notify provider as this is a contraindication for MRI", "Administer sedation", "Remove jewelry"], correctAnswer: "Notify provider as this is a contraindication for MRI", explanation: "MRI is contraindicated with pacemakers." },
    ...
    { q: "Which intervention helps prevent hip flexion contractures after above-knee amputation?", category: "amputations", options: ["Pillows under limb", "Sitting all day", "Lie prone for 20-30 minutes several times daily", "Elevate limb indefinitely"], correctAnswer: "Lie prone for 20-30 minutes several times daily", explanation: "Prone position stretches the hip flexors." },
    { q: "Which technique is correct for residual limb wrapping?", category: "amputations", options: ["Circular from proximal", "Figure-eight to prevent restriction", "Tight bandaging", "Apply once daily"], correctAnswer: "Figure-eight to prevent restriction", explanation: "Figure-eight shapes the limb without restriction." },
    ...
    { q: "Which finding 3 days post-amputation requires immediate notification?", category: "amputations", options: ["Phantom sensation", "Temperature 101.2°F with purulent drainage", "Mild discomfort", "Sadness"], correctAnswer: "Temperature 101.2°F with purulent drainage", explanation: "Signs of infection." },
    ...
    { q: "Instruction for alendronate (Fosamax)?", category: "osteoporosis", options: ["With food", "With 8 oz water, upright 30 min", "At bedtime", "Crush if needed"], correctAnswer: "With 8 oz water, upright 30 min", explanation: "Prevent esophageal irritation." },
    ...
    { q: "Bisphosphonate dental consideration?", category: "osteoporosis", options: ["No cleaning", "Checkup before starting", "Extract teeth", "None"], correctAnswer: "Checkup before starting", explanation: "Risk of osteonecrosis of jaw." },
    ...
    { q: "Calcium supplement administration?", category: "osteoporosis", options: ["All at once", "Divided doses with food/water", "Empty stomach", "No Vitamin D"], correctAnswer: "Divided doses with food/water", explanation: "Divided doses absorb better." },
    { q: "Report finding with teriparatide (Forteo)?", category: "osteoporosis", options: ["Previous radiation therapy", "Cramping", "Calcium supplements", "Postmenopausal"], correctAnswer: "Previous radiation therapy", explanation: "Risk of osteosarcoma." },
    ...
    { q: "Fracture with bone fragmenting into pieces?", category: "trauma", options: ["Oblique", "Comminuted", "Greenstick", "Spiral"], correctAnswer: "Comminuted", explanation: "Comminuted means fragmented." },
    { q: "Cast pain unrelieved by meds? Priority?", category: "trauma", options: ["More meds", "Notify provider immediately", "Elevate", "Ice"], correctAnswer: "Notify provider immediately", explanation: "Sign of compartment syndrome." },
    ...
    { q: "Skeletal traction fact?", category: "trauma", options: ["Light weights", "Remove for repositioning", "Pins in bone, heavier weights", "For spasm only"], correctAnswer: "Pins in bone, heavier weights", explanation: "Pins in bone allow heavier weights." },
    { q: "Care for skeletal traction weights?", category: "trauma", options: ["Remove to reposition", "Hang freely at all times", "Add weight for pain", "Rest on bed"], correctAnswer: "Hang freely at all times", explanation: "Weights must hang free." },
    { q: "Early sign of fat embolism?", category: "trauma", options: ["Petechiae", "Dyspnea with decreased O2 sat", "Resp failure", "Arrest"], correctAnswer: "Dyspnea with decreased O2 sat", explanation: "Hypoxia/dyspnea is early. Petechiae is late." },
    { q: "Fat embolism manifestation in femur fracture?", category: "trauma", options: ["Pain", "Petechial rash on chest with resp distress", "Swelling", "Cool extremity"], correctAnswer: "Petechial rash on chest with resp distress", explanation: "Petechial rash on chest is classic." },
    { q: "Pin care for external fixation?", category: "trauma", options: ["Same swab all pins", "One swab per pin with solution", "Remove crusting", "Ointment"], correctAnswer: "One swab per pin with solution", explanation: "Prevent cross contamination." },
    ...
    { q: "Osteomyelitis complication?", category: "trauma", options: ["Hypoglycemia", "Need for long-term antibiotics (4-6 weeks)", "Immediate resolution", "Weight gain"], correctAnswer: "Need for long-term antibiotics (4-6 weeks)", explanation: "Antibiotics for 4-6 weeks." },
    ...
    { q: "Buck's traction purpose?", category: "trauma", options: ["Permanent stabilization", "Decrease muscle spasms/immobilize", "Replace surgery", "Weight bearing"], correctAnswer: "Decrease muscle spasms/immobilize", explanation: "Temporary immobilization." },
    { q: "Handling wet plaster cast?", category: "trauma", options: ["Fingertips", "Palms", "Hard surface", "Plastic cover"], correctAnswer: "Palms", explanation: "Use palms." },
    { q: "Cast application finding requiring intervention?", category: "trauma", options: ["Itching", "Warmth", "Numbness and tingling", "Swelling"], correctAnswer: "Numbness and tingling", explanation: "Sign of nerve compression." }
];
